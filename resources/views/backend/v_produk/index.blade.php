            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if (request('stok_menipis'))
                        <div class="alert alert-warning" role="alert" style="display:flex;align-items:center;justify-content:space-between;">
                            <span>📦 Menampilkan produk dengan stok menipis (≤ 5)</span>
                            <a href="{{ route('backend.produk.index') }}" style="color:var(--c-orange);font-weight:600;text-decoration:underline;">Tampilkan semua</a>
                        </div>
                    @endif
