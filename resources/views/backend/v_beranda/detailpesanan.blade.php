                    ...
                    <div class="row">
                                    ...
                                    @foreach ($order->orderItems as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><img
                                                    src="{{ asset(
                                                        'storage/img-
                                                    produk/thumb_sm_' . $item->produk->foto,
                                                    ) }}"
                                                    alt="" width="60%"></td>
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control @error('status') is-
invalid @enderror">
                                    ...
                                    <option value="paid"
                                        ...
                                        Diproses</option>
                                    <option value="Kirim"
                                        {{ old('status', $order->status) == 'Kirim' ? 'selected' : '' }}>
