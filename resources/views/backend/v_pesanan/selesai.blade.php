                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('laporan.selesai') }}" class="btn btn-sm btn-primary">
                                <i class="fas fa-print"></i> Cetak Laporan
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered table-striped table-hover" id="tabel-selesai">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>ID Order</th>
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="10" class="text-center">Tidak ada data pesanan selesai.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
