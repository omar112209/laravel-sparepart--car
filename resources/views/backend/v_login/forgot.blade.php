...
<head>
    ...
    <style>
        ...
        .btn-send { background: linear-gradient(135deg, #EF4444, #DC2626); border: none; color: #fff; padding: 10px 28px; border-radius: 6px; font-weight: 600; letter-spacing: 0.5px; transition: all 0.3s ease; width: 100%; margin-top: 10px; }
        .btn-send:hover { background: linear-gradient(135deg, #DC2626, #EF4444); transform: translateY(-1px); box-shadow: 0 8px 20px rgba(239, 68, 68, 0.4); color: #fff; }
