...
<head>
    ...
    <style>
        ...
        .btn-reset { background: linear-gradient(135deg, #C8102E, #9A0C23); border: none; color: #fff; padding: 10px 28px; border-radius: 6px; font-weight: 600; letter-spacing: 0.5px; transition: all 0.3s ease; width: 100%; margin-top: 10px; }
        .btn-reset:hover { background: linear-gradient(135deg, #9A0C23, #C8102E); transform: translateY(-1px); box-shadow: 0 8px 20px rgba(200, 16, 46, 0.4); color: #fff; }
