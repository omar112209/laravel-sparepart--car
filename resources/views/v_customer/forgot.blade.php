...
<div class="auth-wrap">
    <div class="auth-card" style="animation:fadeUp 0.5s ease both;">
        <div class="auth-card-inner">
            ...
            <h1 class="font-display text-[28px] font-extrabold tracking-[1.5px] uppercase text-center m-0 mb-1" style="color:var(--color-text);">Lupa Password</h1>
            <p class="text-center text-[13px] mb-7" style="color:var(--color-text-3);">Masukkan email Anda untuk mendapatkan tautan reset password</p>
